...
def main(
        ...
        rsquared=False,return_freg=False,pair=False):
...
def wrapper(args):
    ...
    MI,Std = main(
        ...
        rsquared=args.rsquared,return_freg=args.return_freg,pair=args.pair)
...
def add_subparser(subparsers):
    p = subparsers.add_parser('predictiveinfo_pair')
    ...
    p.add_argument(
        ...
        calculate error''')
    p.add_argument(
        '--pair',action='store_true',help='''Flag to use if you want to
        calculate MI for pair model.''')
    p.add_argument(
